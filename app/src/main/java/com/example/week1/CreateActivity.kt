...
import com.example.week1.databinding.ActivityCreateBinding
...
class CreateActivity : AppCompatActivity() {
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            ...
            private fun listener() {
                ...
                binding.SubmitAddBut.setOnClickListener{
                    ...
                    var jenis = binding.JenisInputLayout.editText?.text.toString().trim()
    ...
    private fun checker(){
        ...
        if(tempHewan.jenis!!.isEmpty()){
            binding.JenisInputLayout.error = "Jenis harus diisi 1-10"
            isCompleted=false
        }else {
        ...
        if(tempHewan.usia!!.isEmpty()){
            ...
            isCompleted=false
        }else if(tempHewan.usia!!.contains(".*[A-Z].*".toRegex())){
